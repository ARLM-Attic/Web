...
<link href="Ext4.2/resources/css/ext-all-neptune.css" rel="stylesheet" />
	...
	<script type="text/javascript" src="stuScore.js"></script> 	
	
 	<script type="text/javascript" src="teacher_question.js"></script> 	
 	<!--script type="text/javascript" src="List_Teacher.js"></script-->	
    <script type="text/javascript" src="paper_manager.js"></script>
	<script type="text/javascript" src="Menu_teacher.js"></script>
