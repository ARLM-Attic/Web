...
<!-- 头部 -->
	<div id="top_box">
		<div id="top">
			<p id="top_font">YII文章系统后台管理首页 （V1.1）</p>
		</div>
		<div class="top_bar">
			<p class="adm">
				<span>管理员：</span>
				<span class="adm_pic">&nbsp&nbsp&nbsp&nbsp</span>
				<span class="adm_people">[<?php echo Yii::app()->session['name'];  ?>]</span>
			</p>
			<p class="now_time">
...
<!-- 左侧菜单 -->
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				  	...
				  	<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo $this->createUrl('main') ?>" class="pos">系统信息</a>				        	
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
		...
		<!-- 右侧 -->
		<div id="right">
			<iframe  frameboder="0" border="0" 	scrolling="yes" name="iframe" src="<?php echo $this->createUrl('main/main') ?>"></iframe>
		</div>
	<!-- 底部 -->
	<div id="foot_box">
		<div class="foot">
