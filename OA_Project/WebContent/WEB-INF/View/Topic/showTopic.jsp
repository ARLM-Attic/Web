...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 主题列表
        </div>
	...
	<center>
		...
		<div class="ForumPageTableBorder">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<!--主题列表-->
				<tbody class="dataContainer" datakey="lists">
				<s:iterator value="#lists">
					<tr height="35" id="d0" class="template">
						...
						<td class="Topic"><s:a class="Default" action="topic_showReply?id=%{id}">${title}</s:a></td>
